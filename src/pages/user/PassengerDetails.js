    ...
    return (
        <div class="rounded-lg overflow-hidden p-3 shadow-lg bg-gray-900 border-solid border-2 border-gray-900 text-white">
            ...
            <div class="relative">
                ...
                <form className="">
                    <div className="grid sm:grid-rows-2 px-4">
                        {/* <label name="way" className="block text-base text-white font-bold">
                                    TRIP TYPE
                                </label> */}
                        <div className='grid sm:grid-cols-3 gap-2 w-1/2'>
                            ...
                            <div className={`${passengers.gender === "OTHERS" ? "bg-white" : ""} flex items-center px-4 border border-gray-200 rounded dark:border-gray-700`}>
                    ...
                    <div className="grid sm:grid-cols-2 gap-2 sm:w-3/5 px-4">
                        <div>
                        ...
                        </div>
                        {
                            count > passengerArray.length ?
                                <button onClick={(e) => addPassenger(e)} className="w-2/3 text-sm
