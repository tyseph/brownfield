  ...
  return (
    <div class="rounded-lg overflow-hidden p-3 shadow-lg bg-gray-900 border-solid border-2 border-gray-900 text-white">
      <div class="relative">
        ...
        <h1 className="text-gray-100 px-4">
          Passenger {count} / {res.FlightBooking.numberOfPassenger}
        </h1>
        <form className="">
          <div className="">
            ...
            <div className="flex justify-start px-4 mb-4 flex-wrap">
              <div
                className={`${
                  passengers.gender === "MALE" ? "bg-white" : ""
                } mr-4 flex items-center px-4 border border-gray-200 rounded dark:border-gray-700`}
              >
                <input
                  checked={passengers.gender === "MALE" ? true : false}
                  type="radio"
                  name="gender"
                  value="MALE"
                  id="Male"
                  ...
                  className={`${
                    passengers.gender === "MALE"
                      ? "text-gray-800"
                      : "text-white"
                  }  w-8 h-4 bg-gray-100 border-gray-300  dark:bg-gray-700 dark:border-gray-600`}
                />
                <label
                  for="Male"
                  className={`${
              ...
              <div
                className={`${
                  passengers.gender === "FEMALE" ? "bg-white" : ""
                } mr-4 flex items-center px-4 border border-gray-200 rounded dark:border-gray-700`}
              >
                <input
                  checked={passengers.gender === "FEMALE" ? true : false}
                  type="radio"
                  name="gender"
                  value="FEMALE"
                  id="Female"
              ...
              <div
                className={`${
                  passengers.gender === "OTHER" ? "bg-white" : ""
                } mr-4 flex items-center px-4 border border-gray-200 rounded dark:border-gray-700`}
              >
                <input
                  checked={passengers.gender === "OTHER" ? true : false}
                  type="radio"
                  name="gender"
                  value="OTHER"
                  id="Other"
          ...
          <div className="flex flex-wrap justify-start px-4 mb-4">
            <div className="mr-4">
              <label
                className="block uppercase tracking-wide text-gray-100 text-xs font-bold"
                htmlFor="grid-zip"
              >
                First Name
              </label>
          ...
          {count > passengerArray.length ? (
            ...
            <p className="text-gray-100 mt-4 ml-4">
              You Have Added {numberOfPassenger} passengers
            </p>
          )}
