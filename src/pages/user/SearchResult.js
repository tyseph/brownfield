...
const SearchResult = (res) => {
    ...
    return (
        <div>
            <div className='flex flex-wrap justify-center gap-1 searchnav bg-gray-900 p-8' >
            ...
            <div className="py-4 overflow-auto">
                <label name="way" className="block text-base text-gray-900 text-center font-bold">
                    Flights
                </label>
                <div
